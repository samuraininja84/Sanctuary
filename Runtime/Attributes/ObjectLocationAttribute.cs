...
namespace Sanctuary.Attributes
{
    ...
    /// </summary>
    /// <remarks>
    /// The GUID of the scene that this object belongs to will be used as the chunk ID. 
    /// The object ID will be extracted from <see cref="UnityEditor.GlobalObjectId"/>.
    /// This ensures that the location is unique to the object.
    /// If <see cref="IsPrefab"/> is true, the chunk ID will be set to "Prefabs" and the prefab ID will be used as the object ID.
    ...
    public class ObjectLocationAttribute : PropertyAttribute 
    {
        ...
        public ObjectLocationAttribute(bool isPrefab = false) => IsPrefab = isPrefab;
    }
}
