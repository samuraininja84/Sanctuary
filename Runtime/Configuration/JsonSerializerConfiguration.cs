...
namespace Sanctuary.Configuration
{
    ...
    public class JsonSerializerConfiguration : SerializerConfiguration
    {
        ...
        {
            // Return a JSON serializer instance based on the configuration.
            return overrideExtension != null ? JsonSerializer.Create(options, overrideExtension) : JsonSerializer.Create(options);
        }
    }
}
